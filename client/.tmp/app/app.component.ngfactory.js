...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Header_2_3 = new import13.Header(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_2), this.renderer, this.parentInjector.get(import26.ViewController, null));
        ...
        this._Toolbar_4_4 = new import13.Toolbar(this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_4), this.renderer);
        ...
        this._ToolbarTitle_6_4 = new import14.ToolbarTitle(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_6), this.renderer, this._Toolbar_4_4, this.parentInjector.get(import29.Navbar, null));
        ...
        var compView_21 = import35.viewFactory_Nav0(this.viewUtils, this.injector(21), this._appEl_21);
        this._Nav_21_4 = new import18.Nav(this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import36.NavControllerBase, null), this.parentInjector.get(import31.App), this.parentInjector.get(import22.Config), this.parentInjector.get(import23.Keyboard), new import21.ElementRef(this._el_21), this.parentInjector.get(import24.NgZone), this.renderer, this.parentInjector.get(import37.ComponentFactoryResolver), this.parentInjector.get(import25.GestureController), this.parentInjector.get(import38.TransitionController), this.parentInjector.get(import39.DeepLinker, null));
        this._appEl_21.initComponent(this._Nav_21_4, [], compView_21);
        compView_21.create(this._Nav_21_4, [], null);
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import16.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) {
            return this._List_13_3;
        }
        if (((token === import15.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 17)))) {
            return this._Content_11_4;
        }
        if (((token === import12.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._Menu_0_4;
        }
        if (((token === import18.Nav) && (21 === requestNodeIndex))) {
            return this._Nav_21_4;
        }
        return notFoundResult;
    };
    _View_MyApp0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (!throwOnChange) {
            if ((this.numberOfChecks === 0)) {
                this._Nav_21_4.ngAfterViewInit();
            }
        }
    };
...
var _View_MyApp1 = (function (_super) {
    ...
    _View_MyApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import41.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
