...
export function viewFactory_PickerColumnCmp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_PickerColumnCmp === null)) {
        (renderType_PickerColumnCmp = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, styles_PickerColumnCmp, {}));
    }
...
export function viewFactory_PickerCmp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_PickerCmp === null)) {
        (renderType_PickerCmp = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, styles_PickerCmp, {}));
    }
